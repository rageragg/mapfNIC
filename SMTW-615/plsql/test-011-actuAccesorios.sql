...
begin
    --
    dbms_output.put_line('PRUEBA DE ACCESORIOS');
    --
    ...
    l_parametros := '{'||
        ...
        '"marca": "SONY",'||
        '"referencia": "Reproductor Sonido",'||
        '"valor":"59.90",'||
        '"byteFoto":"12123131123"'||
        '},'||
        '{"numeroCotizacion":"2130190001205",' ||
        '"marca": "LOTO",'||
        '"referencia": "Sistemas de Luces HD",'||
        '"valor":"98.98",'||
        '"byteFoto":"5555"'||
        '}'||
        ']}';
    ...
    --
    em_k_ws_auto_inspeccion.p_graba_accesorio_vehiculo( p_parametros   => l_parametros,
                                            p_errores    => l_msg
                                         );
