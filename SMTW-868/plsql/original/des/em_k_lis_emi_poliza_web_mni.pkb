create or replace PACKAGE BODY em_k_lis_emi_poliza_web_mni IS
  ...
  */
  ...
  PROCEDURE p_lista(p_cod_cia           a2000030.cod_cia%TYPE,
                    ...
                    p_fec_proceso       DATE,
                    p_cod_agt           a1001332.cod_agt%TYPE) IS
    --
    ...
    BEGIN
      ...
      g_tab_caption(3).title := 'NOMBRES';
      g_tab_caption(4).title := 'APELLIDOS';
      g_tab_caption(5).title := 'CEDULA';
      g_tab_caption(6).title := 'DIRECCION';
      g_tab_caption(7).title := 'TEL1';
      g_tab_caption(8).title := 'CELULAR';
      g_tab_caption(9).title := 'FEMISION';
      g_tab_caption(10).title := 'FDESDE';
      g_tab_caption(11).title := 'FHASTA';
      g_tab_caption(12).title := 'RAMO';
      g_tab_caption(13).title := 'MARCA';
      g_tab_caption(14).title := 'MODELO';
      g_tab_caption(15).title := 'AÑO';
      g_tab_caption(16).title := 'COLOR';
      g_tab_caption(17).title := 'PLACA';
      g_tab_caption(18).title := 'MOTOR';
      g_tab_caption(19).title := 'CHASIS';
      g_tab_caption(20).title := 'SUMAASEGURADA';
      g_tab_caption(21).title := 'PNETA';
      g_tab_caption(22).title := 'PTOTAL';
      g_tab_caption(23).title := 'IDAGENTE';
      g_tab_caption(24).title := 'IDEJECUTIVO';
      --
  ...
  BEGIN
    ...
    g_fec_proceso := last_day(to_date(trn_k_global.devuelve('JBFEC_HASTA'),
                                      'ddmmyyyy'));
    --
    p_lista(trn_k_global.devuelve('JBCOD_CIA'),
            to_date(trn_k_global.devuelve('JBFEC_DESDE'), 'ddmmyyyy'),
            to_date(trn_k_global.devuelve('JBFEC_HASTA'), 'ddmmyyyy'),
            g_fec_proceso,
            g_cod_agt);
    --
  EXCEPTION
